...
const Navbar = () => {
 ...
 <form  onSubmit = {handlesearch}className="flex-1 max-w-lg mx-4 hidden sm:flex">
  <input
    ...
    className="w-full px-5 py-2 bg-gray-800 text-white border border-gray-700 rounded-l-full placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-inner"
  />

  <button
    type="submit"
    className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-5 rounded-r-full hover:from-blue-600 hover:to-cyan-600 transition duration-300 shadow-lg hover:shadow-blue-500/50"
  >
